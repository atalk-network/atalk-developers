...
- npm coordinated packages: `0.1.0-alpha.14`, distributed under the `next` tag;
- PyPI packages `atalk-sdk` and `atalk-hermes`: `0.1.0a11`, installed with `pip --pre`.

Repository manifests and public documentation now match those coordinated registry releases.
...
| Runtime version advisories and safe external supervision | `0.1.0-alpha.14` | `0.1.0a11` |
