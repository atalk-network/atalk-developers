...
- npm packages: `0.1.0-alpha.7`, distributed under the `next` tag;
- Python packages: `0.1.0a4`, installed with `pip --pre`;
- Git release tags: `node-v0.1.0-alpha.7` and `python-v0.1.0a4`.
...
| Framework integration alpha | `0.1.0-alpha.7` | `0.1.0a4` |
