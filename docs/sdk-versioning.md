...
Repository manifests contain the coordinated `0.1.0-alpha.14` / `0.1.0a11` candidate while it is being validated. Public documentation and product metadata continue to name the registry versions until the new release is available.
