...
This repository accepts contributions to the aTalk protocol, portable Rust core, native Node binding,
Node/Python SDKs and official agent integrations. The hosted service and product applications are
...
- preserve fail-closed Task routing: only verified structured mentions and plan assignments may start
  an autonomous agent turn;
- exercise permission revocation, expiry, approval and idempotent retry paths when changing Task APIs;
